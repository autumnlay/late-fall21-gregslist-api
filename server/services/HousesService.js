...
class HousesService {
  async getAll(query = {}) {
    // REVIEW what is passed through the .populate()? what goes on the inside there, as the parameters??
    // NOTE the dbCOntext refrences that in our server. db. dbContext.
    // Houses refrenses our Schema??
    // .find is a js method.
    // pass in query.
    // .populate does ____
